...
import 'web_comment_screen.dart';
                                      ...
                                      Flexible(
                                        child: StreamBuilder(
                                          ...
                                          builder: (context, commentsnapshot) {
                                            ...
                                            dynamic comment = 0;
                                            DateTime commentDate = DateTime(0);
                                            final numOfComments =
                    ...
                    Expanded(
                      child: TextField(
                        ...
                        decoration: InputDecoration(
                          ...
                          hintText: hintList[Random().nextInt(hintList.length)],
                          labelText: "Item",
                          floatingLabelStyle:
                      ...
                      children: [
                        IconButton(
                          ...
                          icon: Icon(
                            Icons.remove,
                            color:
                                addItemCount == 1 ? Colors.grey : Colors.white,
                          ),
                          onPressed: () => setState(() {
                            if (addItemCount > 1) {
                              addItemCount--;
